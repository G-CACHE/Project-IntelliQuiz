...
\restrict PC5TUebLrkLbDmyxzz58vTgcb9Eh8mbipoFW0RxyLpyT0qdHwzMDyIuwjOUKNiF
...
ALTER TABLE IF EXISTS ONLY public.quiz_assignment DROP CONSTRAINT IF EXISTS fkq15xgwiqmg5qo6wypkrrkcc5k;
ALTER TABLE IF EXISTS ONLY public.question_option DROP CONSTRAINT IF EXISTS fkmmdv54rmm5hkgxbn1008ix87n;
ALTER TABLE IF EXISTS ONLY public.submission DROP CONSTRAINT IF EXISTS fkmgn97o68jw1xnlhje4luw2xmp;
ALTER TABLE IF EXISTS ONLY public.submission DROP CONSTRAINT IF EXISTS fkjskf22duewv7lid6te7nnixdq;
ALTER TABLE IF EXISTS ONLY public.team DROP CONSTRAINT IF EXISTS fkg5ffl41mlfyt7lasn0h4715m8;
ALTER TABLE IF EXISTS ONLY public.question DROP CONSTRAINT IF EXISTS fkb0yh0c1qaxfwlcnwo9dms2txf;
ALTER TABLE IF EXISTS ONLY public.quiz_assignment DROP CONSTRAINT IF EXISTS fkammnyuufr9j6osu3agec84cvx;
ALTER TABLE IF EXISTS ONLY public.assignment_permission DROP CONSTRAINT IF EXISTS fk6ef1m1cs1ioqdwlexuxb1880e;
ALTER TABLE IF EXISTS ONLY public.backup_record DROP CONSTRAINT IF EXISTS fk5vi0ttd1g38h8yk1xdtfv1g6i;
...
ALTER TABLE IF EXISTS ONLY public.backup_record DROP CONSTRAINT IF EXISTS uk_seu5k8o0adwisaothfectynqk;
ALTER TABLE IF EXISTS ONLY public."user" DROP CONSTRAINT IF EXISTS uk_sb8bbouer5wak8vyiiy4pf2bx;
ALTER TABLE IF EXISTS ONLY public.scoreboard_entries DROP CONSTRAINT IF EXISTS uk_209tg1o0uit4frd88bpcmay1o;
...
COPY public.quiz (id, description, is_live_session, proctor_pin, status, title, deleted) FROM stdin;
1		f	101-513	DRAFT	Science Quiz Bee	f
2		f	601-436	DRAFT	Math	f
3		t	888-702	READY	Earth Science	f
\.
...
1	$2b$12$.ToLRXrq06yw22qh.QUA0OBI2rBiQR6U0lYiAuzmoB3rJlG1Ps18O	SUPER_ADMIN	superadmin	f
2	$2a$10$qsVavnRooO4wb3nSB5kJBuuLeR35QOr/tF/tNRijYCRq691KCpsJa	ADMIN	adminIT	f
3	$2a$10$CBBZiQDgr98wgf4qXDQI7ufaMG4KkcGyGQOnbBHCoxH0VFTLbkHw.	ADMIN	adminv2	f
\.
...
\unrestrict PC5TUebLrkLbDmyxzz58vTgcb9Eh8mbipoFW0RxyLpyT0qdHwzMDyIuwjOUKNiF
