...
public interface BackupService {
     ...
     *
     * @param createdByUserId the ID of the user creating the backup
     * @return the created backup record
     */
    BackupRecord createBackup(Long createdByUserId);
     ...
     * @param restoredByUserId the ID of the user performing the restore
     * @return the updated backup record
     */
    BackupRecord restoreFromBackup(Long id, Long restoredByUserId);
